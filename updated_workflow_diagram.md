...
graph TD;
	...
	generate_multi_queries_node(generate_multi_queries_node)
	extract_documents_node(extract_documents_node)
	format_raw_documents_node(format_raw_documents_node)
	process_batches_node(process_batches_node)
	...
	extract_documents_node --> format_raw_documents_node;
	format_raw_documents_node --> process_batches_node;
	generate_multi_queries_node --> extract_documents_node;
	...
	instantiate_retriever_node --> generate_multi_queries_node;
	load_vectorstore_node --> instantiate_retriever_node;
	process_batches_node -.-> combine_answers_node;
	process_batches_node -.-> process_individual_files_node;
	process_individual_files_node --> combine_answers_node;
